...
- **Global scope**: `/Users/sameerrijhsinghani/automation_consulting/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/sameerrijhsinghani/automation_consulting/.claude/notes/`)
...
2. Glob `/Users/sameerrijhsinghani/automation_consulting/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/sameerrijhsinghani/automation_consulting/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/sameerrijhsinghani/automation_consulting/.claude/notes/` — works in any directory
