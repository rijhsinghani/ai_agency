...
- Usage: Reference from command with `@/Users/sameerrijhsinghani/automation_consulting/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/sameerrijhsinghani/automation_consulting/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/sameerrijhsinghani/automation_consulting/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
